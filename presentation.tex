...
\newtheorem{prop}{Vorschlag}
\newtheorem{cor}{Folgerung}
\newtheorem{ex}{Beispiel}
\newtheorem{exer}{Übung}
...
% First one is logo in title slide (we recommend use a horizontal image), and second one is the logo used in the remaining slides (we recommend use a square image); the third one is used as a second logo on the title page
\setLogos{lib/logos/wide-logo.pdf}{lib/logos/square-logo.pdf}{lib/logos/wide-logo.pdf} 
...
\begin{frame}{Example on using box}
    ...
    \end{block}
one is used as a second logo on the title pagelogo-black
\end{frame}
%---------------------------------------------------------
...
\begin{frame}{Example on using image}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=.5\textwidth]{lib/logos/wide-logo.pdf}
        \caption{Template Logo.}
        \label{fig:layouts}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{0.2\textwidth}
            \centering
            \includegraphics[height=1cm]{lib/logos/square-logo.pdf}
        \end{subfigure}%
        \qquad 
        \begin{subfigure}{0.2\textwidth}
            \centering
